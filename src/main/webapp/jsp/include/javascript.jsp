...
<script type="text/javascript" src="/siacrepapp/js/tree/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript" src="/siacrepapp/js/tree/jquery.ztree.excheck-3.5.js"></script>
--%>

<script type="text/javascript" src="${jspathexternal}jquery.bs.allowedChars.js"></script>
